...
public class UserEquipDAO {
	...
	return jdbcTemplate.query("""
		...
		FROM VIEW_WEB_LIST_USER_EQUIP WHERE login = ?""",
...
//	return jdbcTemplate.query(
//		"SELECT registrationNB, serialNB, groupName, modelName, locationName, userName "
//			+ "FROM VIEW_WEB_LIST_USER_EQUIP", new BeanPropertyRowMapper<>(UserEquip.class));
//    }
//
//    public List<UserEquip> getByFilter(String filter) {
//	String sql = "SELECT registrationNB, serialNB, groupName, modelName, locationName, userName "
//		+ "FROM VIEW_WEB_LIST_USER_EQUIP "
...
//		+ "OR userName LIKE ? ";
//	filter = "%"+filter+"%";
//	return jdbcTemplate.query(sql, new Object[] {filter,filter,filter,filter,filter,filter}, new BeanPropertyRowMapper<>(UserEquip.class));
//    }
